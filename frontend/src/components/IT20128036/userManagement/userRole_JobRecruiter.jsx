...
export default class UserRoles_JonRecruiter extends Component {
...
<RightSidePanel/>
          ...
          <div className='row'>
            <div className="btn-group">
              <a href="/admin/userroles" className="btn btn-outline-dark" aria-current="page">All Users</a>
              <a href="/admin/user/recruiter" className="btn btn-outline-dark active">Job Recruiter</a>
