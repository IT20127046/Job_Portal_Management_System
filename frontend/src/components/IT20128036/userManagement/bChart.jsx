...
export default function BChart() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/users").then((res) => {
      ...
      let jobseekers = 0;
      users.forEach(user => {
        if (user.type === "Job Recruiter" && user.dateRegistered ==="2022-08-31T08:04:59.118Z" ) {
...
//   const data = [
//     { name: "Group A", value: jobseekers },
//     { name: "Group B", value: recruiters },
//     { name: "Group B", value: all },
