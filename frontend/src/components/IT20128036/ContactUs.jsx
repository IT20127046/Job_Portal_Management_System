...
export default function ContactUs() {
  ...
  const onSubmit = (e) => {
    ...
    axios.post("http://localhost:5000/inquiries/add", data).then((res) => {
      if (res.data.success) {
        swal("Send successfully!", "", "success").then(
          (value) => {
            if (value) {
...
<div className="container ">
    <div className="row">
        ...
        <div className="p-3 mb-2 mt-3 text-dark slidebar">
          ...
          <div>
            <a href=''>
              <div className="p-2 mb-2 text-white" style={{ background: '', textDecoration: 'none' }}>
                <a className="btn text-dark">
...
<h5 className="text-center mt-4">Inquiries</h5>
    ...
    <div className="p-3 mb-2 " >
      ...
      <form >
        ...
        <label htmlFor="subject" className="mt-2 mb-2">Subject</label>
        ...
        >
          ...
          <option title="Job Inquiries">
          Job Inquiries
          </option>
          <option title="Companies Inquiries">
          Companies Inquiries
          </option>
          <option title="Other Inquiries">
           Other Inquiries
          </option>
        </select>

        <label htmlFor="message" className="mt-2 mb-2">Message</label>
        <textarea
...
<div className="row">
    ...
    <button type="submit" onClick={onSubmit} className="btn btn-dark mt-2 mb-2">
          Send
        </button></div>
