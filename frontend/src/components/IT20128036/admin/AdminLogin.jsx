...
function AdminLogin() {
    ...
    return (
        ...
        <div className='jumbotron' style={{ paddingLeft: '50px', paddingRight: '50px', paddingBottom: '50px', paddingTop: '10px', backgroundImage: `url(${bgimg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', margin: '0px 0px 0px 0px', overflow: 'hidden', minHeight: '100vh' }}>

            <div className="container" style={{ marginTop: '50px', marginBottom: '50px', backgroundImage: `url(${image})`, paddingBottom: '200px', paddingTop: '50px', paddingLeft: '100px', paddingRight: '100px' }}>
  <div className='row'>
                ...
                <div className="col-md-12 mt-4 mx-auto">
                    ...
                    <form className="needs-validation" noValidate>
                        ...
                        <div class="d-grid gap-2">
                            <button className="btn btn-dark" type="submit" style={{ marginTop: '15px', width: 'cover' }} onClick={loginAdmin}>
                                Login
                            </button>
                        </div>
                    </form>
